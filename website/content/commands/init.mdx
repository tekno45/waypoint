...
- `-from-project=<string>` - Create a new application by fetching the given application from a remote source
- `-into=<string>` - Where to write the application fetched via -from
